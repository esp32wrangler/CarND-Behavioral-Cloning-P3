...
lines = csvfile1.readlines() + csvfile2.readlines() + csvfile3.readlines() + csvfile4.readlines()  + \
        csvfile5.readlines()  + csvfile6.readlines()  + csvfile7.readlines() + csvfile12.readlines() #+ csvfile10.readlines() #+ csvfile11.readlines()
#csvfile10.readlines()        csvfile10.readlines() + csvfile10.readlines() + csvfile10.readlines()
